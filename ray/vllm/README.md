    ...
    - name: llm
      ...
      runtime_env:
        ...
        env_vars:
          ...
          MODEL_ID: "/home/ray/Qwen2.5-0.5B-Instruct"
    ...
    headGroupSpec:
      ...
      template:
        ...
        spec:
          containers:
          - name: ray-head
            #image: rayproject/ray:2.35.0-py310-cpu
            image: ghcr.io/bincherry/ray:2.35.0-py310-cpu-vllm-qwen_qwen2_5_0_5b_instruct
