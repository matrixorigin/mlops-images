...
# CPU
DOCKERFILE_BASE=./Dockerfile-base.cpu
IMAGE_TAG_BASE=${RAY_VERSION}-py310-cpu-vllm-base
...
# GPU
# DOCKERFILE_BASE=./Dockerfile-base.cuda
# IMAGE_TAG_BASE=${RAY_VERSION}-py310-cu121-vllm-base
